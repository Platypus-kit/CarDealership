...
{
    public interface IIRoleService //методы для управления ролями и правами
    {
        ...
        Task<GetAllRolesResponse> GetAllRolesAsync(GetAllRolesRequest GetAllRolesRequest); //- получение всех ролей
